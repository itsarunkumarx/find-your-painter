...
export const sendCallNotification = async (targetUserId, callData) => {
    try {
        ...
        const notificationPayload = JSON.stringify({
            title: 'Incoming Call',
            body: `Incoming ${callData.callType || 'voice'} call from ${callData.callerName}`,
            url: `/?autoAccept=true&callId=${callData.callId}&callerName=${encodeURIComponent(callData.callerName || '')}`,
            type: 'call',
            ...callData
        });
